# Zabezpiecz program zliczający punkty w grach (moduł 14, lab 3) przed wprowadzaniem błędnych danych przez użytkownika.
...
def show_results(players, winner):
    print("Wygrał gracz o imieniu", winner, ", gratulacje!\n")
